...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.versacoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.versacoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
    ...
    private static final String BITCOIN_SIGNED_MESSAGE_HEADER = "VersaCoin Signed Message:\n";
