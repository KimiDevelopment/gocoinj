...
import org.versacoinj.crypto.TransactionSignature;
...
import org.versacoinj.script.ScriptError;
import org.versacoinj.script.ScriptException;
import org.versacoinj.script.ScriptOpCodes;
...
import static org.versacoinj.core.Utils.*;
...
public class Transaction extends ChildMessage {
     ...
     */
    public static final Coin DEFAULT_TX_FEE = Coin.valueOf(40000); // 0.4 mBTC
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint prevOut, Coin amount, Script scriptPubKey, ECKey sigKey)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int inputIndex, byte[] redeemScript, SigHash type, boolean anyoneCanPay)}
