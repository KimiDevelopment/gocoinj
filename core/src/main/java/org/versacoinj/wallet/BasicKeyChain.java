...
import org.versacoinj.utils.ListenerRegistration;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.versacoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.versacoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
