...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.versacoinj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.versacoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.versacoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
