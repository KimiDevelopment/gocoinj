...
import org.versacoinj.core.listeners.*;
import org.versacoinj.core.Address;
import org.versacoinj.core.Base58;
import org.versacoinj.core.AbstractBlockChain;
import org.versacoinj.core.BlockChain;
import org.versacoinj.core.BloomFilter;
import org.versacoinj.core.Coin;
import org.versacoinj.core.Context;
import org.versacoinj.core.ECKey;
import org.versacoinj.core.FilteredBlock;
import org.versacoinj.core.InsufficientMoneyException;
import org.versacoinj.core.LegacyAddress;
import org.versacoinj.core.Message;
import org.versacoinj.core.NetworkParameters;
import org.versacoinj.core.Peer;
import org.versacoinj.core.PeerFilterProvider;
import org.versacoinj.core.PeerGroup;
import org.versacoinj.core.Sha256Hash;
import org.versacoinj.core.StoredBlock;
import org.versacoinj.core.Transaction;
import org.versacoinj.core.TransactionBag;
import org.versacoinj.core.TransactionBroadcast;
import org.versacoinj.core.TransactionBroadcaster;
import org.versacoinj.core.TransactionConfidence;
import org.versacoinj.core.TransactionInput;
import org.versacoinj.core.TransactionOutPoint;
import org.versacoinj.core.TransactionOutput;
import org.versacoinj.core.UTXO;
import org.versacoinj.core.UTXOProvider;
import org.versacoinj.core.UTXOProviderException;
import org.versacoinj.core.Utils;
import org.versacoinj.core.VerificationException;
import org.versacoinj.core.TransactionConfidence.*;
import org.versacoinj.crypto.*;
import org.versacoinj.script.*;
import org.versacoinj.script.Script.ScriptType;
import org.versacoinj.signers.*;
import org.versacoinj.utils.*;
import org.versacoinj.wallet.Protos.Wallet.*;
import org.versacoinj.wallet.WalletTransaction.*;
import org.versacoinj.wallet.listeners.CurrentKeyChangeEventListener;
import org.versacoinj.wallet.listeners.KeyChainEventListener;
import org.versacoinj.wallet.listeners.ScriptsChangeEventListener;
import org.versacoinj.wallet.listeners.WalletChangeEventListener;
import org.versacoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.versacoinj.wallet.listeners.WalletCoinsSentEventListener;
import org.versacoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
...
public class Wallet extends BaseTaggableObject
     ...
     * @throws org.versacoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.versacoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.versacoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
